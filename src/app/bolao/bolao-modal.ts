...
import { groupMatchesPreservingOrder, stageLabel, STAGE_ORDER } from '../wc/wc-derivations';
import { isPlaceholderTeam } from '../wc/teams';
import { parseEntries } from './bolao-io';
import { BolaoStore } from './bolao-store';
import { DraftLine, Palpite } from './bolao.types';
import {
  CanEditPipe,
  IsPlaceholderPipe,
  IsScorablePipe,
...
@Component({
  ...
  templateUrl: './bolao-modal.html',
  styleUrl: './bolao-modal.css',
})
